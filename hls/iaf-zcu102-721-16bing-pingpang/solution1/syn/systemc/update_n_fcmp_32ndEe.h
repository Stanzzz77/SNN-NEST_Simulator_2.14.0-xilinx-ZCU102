...
#ifndef __update_n_fcmp_32ndEe__HH__
#define __update_n_fcmp_32ndEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(update_n_fcmp_32ndEe) {
    ...
    SC_CTOR(update_n_fcmp_32ndEe):  ACMP_fcmp_comb_U ("ACMP_fcmp_comb_U") {
