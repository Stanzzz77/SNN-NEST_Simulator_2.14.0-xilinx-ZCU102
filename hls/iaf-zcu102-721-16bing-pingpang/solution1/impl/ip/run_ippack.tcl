...
set IPName      "update_n"
set Version     "1.0"
set DisplayName "Update_n"
set Revision    "2108222228"
...
set Interfaces {
    ...
    ap_clk {
        ...
        buses "s_axi_ctrl_bus m_axi_stable_para m_axi_input01 m_axi_input00 m_axi_output0_s m_axi_output1_s"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_stable_para {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_stable_para"
        data_width "512"
        param_prefix "C_M_AXI_STABLE_PARA"
    ...
    m_axi_input01 {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_input01"
        data_width "1024"
        param_prefix "C_M_AXI_INPUT01"
    ...
    m_axi_input00 {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_input00"
        data_width "1024"
        param_prefix "C_M_AXI_INPUT00"
        port_width "AWADDR 32 AWID 1 AWUSER 1 WDATA 1024 WSTRB 128 WID 1 WUSER 1 ARADDR 32 ARID 1 ARUSER 1 RDATA 1024 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
    ...
    m_axi_output0_s {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_output0_s"
        data_width "32"
        param_prefix "C_M_AXI_OUTPUT0_S"
    ...
    m_axi_output1_s {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_output1_s"
        data_width "32"
        param_prefix "C_M_AXI_OUTPUT1_S"
        port_width "AWADDR 32 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 32 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
...
## System Info
set user_parameters_list {clk_period 10 machine 64 combinational 0 latency 40 II x}
