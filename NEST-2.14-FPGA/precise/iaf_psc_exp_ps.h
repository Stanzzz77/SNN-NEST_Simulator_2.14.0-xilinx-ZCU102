...
{
/* BeginDocumentation
   Name: iaf_psc_exp_ps - Leaky integrate-and-fire neuron model with exponential
                       PSCs.
   ...
   optimization levels. A future version of iaf_psc_exp_ps will probably
...
Remarks:
   ...
   iaf_psc_exp_ps can handle current input in two ways: Current input
